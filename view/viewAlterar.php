    ...
    <div class="container py-4">
        <form class="form" method="post" action="viewAlterar.php">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="endereco" placeholder="Endereço" value="<?php echo $_GET['endereco']; ?>" />
            ...
            <div class="row">
                <div class="col">
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" name="telefone" placeholder="telefone" value="<?php echo $_GET['telefone']; ?>" />
